...
class CreateCardInfo:
    ...
    def create_card_name_random(self):
        for number_index in range(4500):
            ...
            self.card_info['nameinfo'].append(number_random_str)
    ...
    def create_cardname_sample(self,savepath='D://cardnumberdataset//'):
        ...
        for name_id in range(len(self.card_info['nameinfo'])):
            try:
                ...
                lable_cur.write(savepath + 'number_' + str(len(self.card_info['nameinfo'][name_id])) + '_' + str(name_id) + '.jpg' + '\t' + self.card_info['nameinfo'][name_id])
                lable_cur.write('\n')
            except:
                pass
...
CCI = CreateCardInfo()
CCI.create_card_name_random()
print(CCI.card_info['nameinfo'])
